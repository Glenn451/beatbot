...
class Music(commands.Cog):
    ...
    @commands.command(name='skip', aliases=['fs', 'next'], description="skips to next song in queue")
    ...
    @commands.command(name='remove', aliases=['rm', 'rem', 'r'], description="removes specified song from queue")
    ...
    @commands.command(name='volume', aliases=['vol', 'v'], description="changes BeatBot's volume")
    ...
    @commands.command(name='leave', aliases=["stop", "dc", "disconnect", "bye", "fuckoff", "goaway"], description="stops music and disconnects from voice")
